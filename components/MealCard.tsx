...
export function MealCard({
  ...
  return (
    <>
      <Card
        className={[
          "flex flex-col transition-all overflow-hidden cursor-pointer",
      ...
      >
        ...
        <CardContent className="flex flex-col gap-4 flex-1">
          ...
          {/* Actions */}
          <div className="flex flex-col gap-2 mt-auto pt-2" onClick={(e) => e.stopPropagation()}>
            {variant === "saved" ? (
              <Button
                size="sm"
                variant="secondary"
      ...
      <RecipeModal meal={meal} open={modalOpen} onOpenChange={setModalOpen} />
    </>
  );
}
